...
def load_image(image_path: str, size_ratio:float=1.0) -> Tuple[np.array, torch.Tensor]:
    transform = T.Compose(
        [
    ...
    image_source = image_source.resize((int(image_source.width * size_ratio), int(image_source.height * size_ratio)))
